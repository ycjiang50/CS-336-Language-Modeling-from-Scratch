...
def parse_args():
    ...
    # Model arguments
    parser.add_argument('--vocab_size', type=int, default=50257, help='Size of vocabulary')
...
def main():
    ...
    for iter_num in pbar:
        ...
        if iter_num % args.save_intervals == 0 and iter_num > 0:
            ...
            save_checkpoint(model, optimizer, iter_num, checkpoint_path, config=config)
    ...
    save_checkpoint(model, optimizer, args.train_steps, final_checkpoint_path, config=config)
